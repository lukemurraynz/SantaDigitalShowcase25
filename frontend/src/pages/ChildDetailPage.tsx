...
export const ChildDetailPage: React.FC<Props> = ({ childId }) => {
  ...
  async function load() {
    ...
    // Clear old recommendations immediately when loading new child
    setRecs([]);
    try {
          ...
          <div style={{ 
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: '0.8rem', color: 'rgba(255,255,255,0.9)' }}>
                Generated by Microsoft Agent Framework + Azure OpenAI • Preference-based • Behavior-aware • Real-time Drasi data
              </p>
            </div>
          </div>
          <p style={{ fontSize:'0.85rem', opacity:0.8, marginBottom: '0.5rem' }}>
            ✨ Recommendations are personalized based on <strong>what the child asked for</strong>, 
            their Nice/Naughty status, and real-time trending data from Santa's Workshop.
          </p>
